...
import com.module.system.dto.translation.PermissionTranslation;
...
public class PermissionServiceImpl implements PermissionService {
    ...
    @Autowired
    private PermissionTranslation permissionTranslation;

    @Override
    public PermissionDTO findById(long id) {
        Optional<Permission> permission = permissionRepository.findById(id);
        ValidationUtil.isNull(permission,"Permission","id",id);
        return permissionTranslation.toDto(permission.get());
    }
    ...
    public PermissionDTO create(Permission resources) {
        ...
        return permissionTranslation.toDto(permissionRepository.save(resources));
    }
